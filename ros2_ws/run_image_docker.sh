...
docker run -dt --name robotchenilles \
  ...
  -v /usr/lib/aarch64-linux-gnu/libcamera.so.0.5.2:/usr/lib/aarch64-linux-gnu/libcamera.so.0.2 \
  -v /usr/lib/aarch64-linux-gnu/libcamera-base.so.0.5.2:/usr/lib/aarch64-linux-gnu/libcamera-base.so.0.2 \
